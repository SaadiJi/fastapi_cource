...
#     res = authorized_client.post("/vote/", json={"post_id": test_posts[2].id, "dir": 0})
#     assert res.status_code ==  404 # but here 409 error is occoring conflict of resources


# def test_vote_post_non_exist(authorized_client, test_posts):
#     res = authorized_client.post("/vote/", json={"post_id": 8000, "dir": 1})
#     assert res.status_code ==  404 #AttributeError: 'Vote' object has no attribute 'id'
